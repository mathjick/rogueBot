...
Shader "LazyEti/BIRP/FakePointLight"
{
	Properties
	{
		...
		_StepsSpacing("Steps Spacing", Range( 1 , 5)) = 2
	...
	LOD 100
		...
		Pass
		{
			...
			float3 InvertDepthDir72_g712( float3 In )
			{
				float3 result = In;
			...
			float ExperimentalScreenShadowsBIRP223_g721( float3 _LightPos, float3 _ScreenPos, float _Spacing )
			{
			...
			v2f vert ( appdata v )
			{
				...
				float3 vertexToFrag7_g723 = worldSpaceLightDir;
				o.ase_texcoord4.xyz = vertexToFrag7_g723;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float mulTime17_g714 = _Time.y * ( _FlickerSpeed * 4 );
				#ifdef _PARTICLEMODE_ON
				float staticSwitch1913 = i.ase_texcoord2.w;
				#else
				float staticSwitch1913 = _randomOffset;
				#endif
				float x58_g714 = ( mulTime17_g714 + ( staticSwitch1913 * UNITY_PI ) );
				float localnoise58_g714 = noise58_g714( x58_g714 );
				float temp_output_44_0_g714 = ( ( 1.0 - _FlickerSoftness ) * 0.5 );
				#ifdef ___FLICKERING____ON
				float staticSwitch53_g714 = saturate( (( 1.0 - _FlickerIntensity ) + ((0.0 + (localnoise58_g714 - -2.0) * (1.0 - 0.0) / (2.0 - -2.0)) - ( 1.0 - temp_output_44_0_g714 )) * (1.0 - ( 1.0 - _FlickerIntensity )) / (temp_output_44_0_g714 - ( 1.0 - temp_output_44_0_g714 ))) );
				#else
				float staticSwitch53_g714 = 1.0;
				#endif
				float FlickerAlpha416 = staticSwitch53_g714;
				...
				float smoothstepResult593 = smoothstep( 0.0 , ( staticSwitch726 * FlickerSize477 ) , ( dotResult962 > 0.0 ? length( ( ( (( staticSwitch712 - worldToClip583NDC )).xyw * float3( appendResult1075 ,  0.0 ) ) * ( unity_OrthoParams.w <= 0.0 ? ( distance( _WorldSpaceCameraPos , staticSwitch730.xyz ) / -UNITY_MATRIX_P[ 1 ][ 1 ] ) : unity_OrthoParams.x ) ) ) : 20.0 ));
				float HaloMask616 = ( 1.0 - smoothstepResult593 );
				float temp_output_5_0_g717 = ( 256.0 / _HaloPosterize );
				float HaloPosterized651 = ( HaloMask616 * saturate( ( floor( ( HaloMask616 * temp_output_5_0_g717 ) ) / temp_output_5_0_g717 ) ) );
				float2 temp_cast_5 = (( 1.0 - HaloPosterized651 )).xx;
				float4 temp_output_608_0 = ( HaloPosterized651 * SAMPLE_TEXTURE2D( _GradientTexture, sampler_GradientTexture, temp_cast_5 ) * _HaloTint * i.ase_color );
				float2 temp_cast_6 = (( 1.0 - HaloPosterized651 )).xx;
				float4 screenPos = i.ase_texcoord3;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 UV22_g713 = ase_screenPosNorm.xy;
				float2 localUnStereo22_g713 = UnStereo( UV22_g713 );
				float2 break64_g712 = localUnStereo22_g713;
				float clampDepth69_g712 = SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy );
				#ifdef UNITY_REVERSED_Z
				float staticSwitch38_g712 = ( 1.0 - clampDepth69_g712 );
				#else
				float staticSwitch38_g712 = clampDepth69_g712;
				#endif
				float3 appendResult39_g712 = (float3(break64_g712.x , break64_g712.y , staticSwitch38_g712));
				float4 appendResult42_g712 = (float4((appendResult39_g712*2.0 + -1.0) , 1.0));
				float4 temp_output_43_0_g712 = mul( unity_CameraInvProjection, appendResult42_g712 );
				float3 temp_output_46_0_g712 = ( (temp_output_43_0_g712).xyz / (temp_output_43_0_g712).w );
				float3 In72_g712 = temp_output_46_0_g712;
				float3 localInvertDepthDir72_g712 = InvertDepthDir72_g712( In72_g712 );
				float4 appendResult49_g712 = (float4(localInvertDepthDir72_g712 , 1.0));
				float eyeDepth6_g711 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy ));
				ase_worldViewDir = normalize(ase_worldViewDir);
				float4x4 invertVal29_g711 = Inverse4x4( UNITY_MATRIX_M );
				float dotResult4_g711 = dot( ase_worldViewDir , -mul( UNITY_MATRIX_M, float4( (transpose( mul( invertVal29_g711, UNITY_MATRIX_I_V ) )[2]).xyz , 0.0 ) ).xyz );
				float3 temp_output_9_0_g711 = ( ( eyeDepth6_g711 * ( ase_worldViewDir / dotResult4_g711 ) ) + _WorldSpaceCameraPos );
				float4 ifLocalVar62_g711 = 0;
				if( unity_OrthoParams.w <= 0.0 )
				ifLocalVar62_g711 = float4( temp_output_9_0_g711 , 0.0 );
				else
				ifLocalVar62_g711 = mul( unity_CameraToWorld, appendResult49_g712 );
				float4 ReconstructedPos539 = ifLocalVar62_g711;
				...
				float mulTime41_g716 = _Time.y * ( _NoiseMovement * 0.2 );
				float3 objToWorld506 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
				float3 temp_output_8_0_g716 = ( ( ReconstructedPos539 - float4( objToWorld506 , 0.0 ) ).xyz * ( _NoiseScale * 0.1 ) );
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float2 uvs2041 = ase_grabScreenPosNorm.xy;
				float4 localNormalTex2041 = NormalTex( uvs2041 );
				float depthDecodedVal2024 = 0;
				float3 normalDecodedVal2024 = float3(0,0,0);
				DecodeDepthNormal( localNormalTex2041, depthDecodedVal2024, normalDecodedVal2024 );
				...
				float3 temp_output_24_0_g716 = abs( round( worldNormals1927 ) );
				float temp_output_22_0_g716 = (temp_output_24_0_g716).x;
				float2 lerpResult19_g716 = lerp( (( ( float3(0.78,0.9,-0.72) * mulTime41_g716 ) + temp_output_8_0_g716 )).xz , (( ( float3(0.78,0.9,-0.72) * mulTime41_g716 ) + temp_output_8_0_g716 )).yz , temp_output_22_0_g716);
				float temp_output_23_0_g716 = (temp_output_24_0_g716).z;
				float2 lerpResult20_g716 = lerp( lerpResult19_g716 , (( ( float3(0.78,0.9,-0.72) * mulTime41_g716 ) + temp_output_8_0_g716 )).xy , temp_output_23_0_g716);
				float2 lerpResult46_g716 = lerp( (( ( mulTime41_g716 * float3(-0.86,-0.6,0.82) ) + temp_output_8_0_g716 )).xz , (( ( mulTime41_g716 * float3(-0.86,-0.6,0.82) ) + temp_output_8_0_g716 )).yz , temp_output_22_0_g716);
				float2 lerpResult47_g716 = lerp( lerpResult46_g716 , (( ( mulTime41_g716 * float3(-0.86,-0.6,0.82) ) + temp_output_8_0_g716 )).xy , temp_output_23_0_g716);
				#ifdef ___NOISE____ON
				float staticSwitch853 = saturate( ( _Noisiness * SAMPLE_TEXTURE2D( _NoiseTexture, sampler_NoiseTexture, lerpResult20_g716 ).r * SAMPLE_TEXTURE2D( _NoiseTexture, sampler_NoiseTexture, lerpResult47_g716 ).r ) );
				#else
				...
				float temp_output_5_0_g722 = ( 256.0 / _LightPosterize );
				float GradientMask555 = ( ( 1.0 - smoothstepResult745 ) * saturate( ( floor( ( ( 1.0 - smoothstepResult745 ) * temp_output_5_0_g722 ) ) / temp_output_5_0_g722 ) ) );
				float2 temp_cast_21 = (( 1.0 - GradientMask555 )).xx;
				float4 temp_output_200_0 = ( GradientMask555 * SAMPLE_TEXTURE2D( _GradientTexture, sampler_GradientTexture, temp_cast_21 ) * _LightTint * i.ase_color );
				float2 temp_cast_22 = (( 1.0 - GradientMask555 )).xx;
				...
				#endif
				float4 unityObjectToClipPos237_g721 = UnityObjectToClipPos( staticSwitch1850.xyz );
				float4 worldToClip255_g721 = mul(UNITY_MATRIX_VP, float4(WorldPosition, 1.0));
				float4 worldToClip255_g721NDC = worldToClip255_g721/worldToClip255_g721.w;
				float2 appendResult161_g721 = (float2(( _ScreenParams.x / _ScreenParams.y ) , 1.0));
				float4 break29_g721 = ( ( unityObjectToClipPos237_g721 - worldToClip255_g721NDC ) * float4( appendResult161_g721, 0.0 , 0.0 ) );
				float2 appendResult14_g721 = (float2(break29_g721.x , ( -break29_g721.y * 2 )));
				float temp_output_13_0_g721 = -break29_g721.y;
				float3 appendResult44_g721 = (float3(appendResult14_g721 , ( temp_output_13_0_g721 > 0.0 ? -0.001 : temp_output_13_0_g721 )));
				float4 break206_g721 = ( float4( appendResult161_g721, 0.0 , 0.0 ) * ( ( unityObjectToClipPos237_g721 / unityObjectToClipPos237_g721.w ) - worldToClip255_g721NDC ) );
				float2 appendResult207_g721 = (float2(break206_g721.x , ( -break206_g721.y * 2 )));
				float eyeDepth210_g721 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy ));
				float3 appendResult46_g721 = (float3(appendResult207_g721 , ( 5.0 * saturate( ( break206_g721.y + 0.3 ) ) * ( saturate( ( 1.0 - abs( ase_worldViewDir.y ) ) ) + 0.5 ) * ( 1.0 - eyeDepth210_g721 ) )));
				float3 temp_output_28_0_g721 = ( unity_OrthoParams.w > 0.0 ? appendResult44_g721 : appendResult46_g721 );
				float3 _LightPos223_g721 = temp_output_28_0_g721;
				float3 _ScreenPos223_g721 = ase_screenPosNorm.xyz;
				float _Spacing223_g721 = _StepsSpacing;
				float localExperimentalScreenShadowsBIRP223_g721 = ExperimentalScreenShadowsBIRP223_g721( _LightPos223_g721 , _ScreenPos223_g721 , _Spacing223_g721 );
				#ifdef _SHADOWSHEAVY_ON
				float staticSwitch7_g721 = localExperimentalScreenShadowsBIRP223_g721;
				#else
				float staticSwitch7_g721 = 1.0;
				#endif
				float ScreenSpaceShadows1881 = staticSwitch7_g721;
				...
				half3 hsvTorgb47_g714 = HSVToRGB( half3(radians( staticSwitch53_g714 ),1.0,1.0) );
				float3 lerpResult51_g714 = lerp( hsvTorgb47_g714 , float3( 1,1,1 ) , staticSwitch53_g714);
				float3 FlickerHue1892 = lerpResult51_g714;
				float3 vertexToFrag7_g723 = i.ase_texcoord4.xyz;
				float dotResult3_g723 = dot( -vertexToFrag7_g723 , float3( 0,1,0 ) );
				...
				float Dist41_g724 = distance( ( staticSwitch1917.xyz * _Vector0 ) , ( _Vector0 * _WorldSpaceCameraPos ) );
				
				
				finalColor = ( ( staticSwitch1971 + ( temp_output_200_0 * ( (temp_output_200_0).a * surfaceMask487 * NormalsMasking552 * 0.4 ) ) ) * float4( FlickerHue1892 , 0.0 ) * ( (( DayAlpha )?( saturate( ( dotResult3_g723 * 4.0 ) ) ):( 1.0 )) * FlickerAlpha416 * (( DistanceFade )?( ( saturate( ( 1.0 - ( ( Dist41_g724 - _FarFade ) / _FarTransition ) ) ) * saturate( ( ( Dist41_g724 - _CloseFade ) / _CloseTransition ) ) ) ):( 1.0 )) ) );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19501
Node;AmplifyShaderEditor.CommentaryNode;480;-1731.524,-1077.199;Inherit;False;1445.708;442.8386;;14;711;55;264;255;420;262;478;680;263;654;261;260;259;539;World SphericalMask;0.9034846,0.5330188,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;2040;-1706.979,-1027.095;Inherit;False;Reconstruct World Pos from Depth VR;-1;;711;474d2b03c8647914986393f8dfbd9fe4;0;0;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1914;-4315.652,-979.697;Inherit;False;Property;_randomOffset;randomOffset;23;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;2026;-4434,462;Inherit;False;1204;277;Get Normals;5;12;2024;2025;1927;2041;;1,1,1,1;0;0
Node;AmplifyShaderEditor.StaticSwitch;1913;-3989.652,-912.697;Inherit;False;Property;_ParticleMesh;ParticleMesh;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;255;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;463;-3587.511,-839.5694;Inherit;False;Property;_SizeFlickering;Size Flickering;22;0;Create;True;0;0;0;False;0;False;0.1;0.2;0;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1983;-3716.636,-985.2504;Inherit;False;FlickerFunction;17;;714;f6225b1ef66c663478bc4f0259ec00df;0;4;9;FLOAT;0;False;8;FLOAT;0;False;21;FLOAT;0;False;29;FLOAT;0;False;2;FLOAT;0;FLOAT3;45
...
Node;AmplifyShaderEditor.TransformPositionNode;584;-4240,-48;Inherit;False;Object;Clip;True;Fast;True;1;0;FLOAT3;0,0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TransformPositionNode;716;-4240,96;Inherit;False;World;Clip;True;Fast;True;1;0;FLOAT3;0,0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldPosInputsNode;582;-4016,64;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GrabScreenPosition;12;-4353.016,521.1653;Inherit;False;0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;712;-4016,-48;Inherit;False;Property;_ParticleMesh;ParticleMesh;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;255;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TransformPositionNode;583;-3840,64;Inherit;False;World;Clip;True;Fast;True;1;0;FLOAT3;0,0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScreenParams;587;-3616,48;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CustomExpressionNode;2041;-4088.585,520.9379;Inherit;False;#ifdef STEREO_INSTANCING_ON$return SAMPLE_TEXTURE2D_ARRAY(_CameraDepthNormalsTexture,sampler_CameraDepthNormalsTexture,uvs,unity_StereoEyeIndex)@$#else$return SAMPLE_TEXTURE2D(_CameraDepthNormalsTexture,sampler_CameraDepthNormalsTexture,uvs)@$#endif;4;Create;1;True;uvs;FLOAT2;0,0;In;;Inherit;False;NormalTex;False;True;0;;False;1;0;FLOAT2;0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;585;-3584,-48;Inherit;False;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.DecodeDepthNormalNode;2024;-3905.3,519.8;Inherit;False;1;0;FLOAT4;0,0,0,0;False;2;FLOAT;0;FLOAT3;1
...
Node;AmplifyShaderEditor.StaticSwitch;730;-2752,48;Inherit;False;Property;_ParticleMesh;ParticleMesh;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;255;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ComponentMaskNode;1074;-3424,-48;Inherit;False;True;True;False;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;594;-1632,16;Inherit;False;Property;_HaloSize;Halo Size;9;1;[Header];Create;True;0;0;0;False;0;False;1;4.35;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2003;-2512,48;Inherit;False;PerspectiveScalingFunction;-1;;715;ae280d8cb1effe748857bbeed4caf0b3;0;1;9;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;621;-2720,176;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;591;-3200,-48;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;623;-2208,-48;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2015;-866.6163,-468.5807;Inherit;False;3DNoiseMap;25;;716;2fca756491ec7bf4e9c71d18280c45cc;0;5;56;FLOAT;0;False;1;FLOAT3;0,0,0;False;21;FLOAT3;0,0,0;False;7;FLOAT;0;False;54;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LengthOpNode;586;-2064,-48;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;726;-1168,16;Inherit;False;Property;_ParticleMesh;ParticleMesh;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;255;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;853;-549.4682,-492.0063;Inherit;False;Property;___Noise___;___Noise___;24;0;Create;True;0;0;0;False;1;Space(25);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TransformPositionNode;437;-4160,-544;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;566;-3600,-544;Inherit;False;Property;_ParticleMesh;ParticleMesh;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;255;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;1850;-2688,544;Inherit;False;Property;_ParticleMesh;ParticleMesh;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;255;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;642;144,-544;Inherit;False;SimplePosterize;-1;;717;163fbd1f7d6893e4ead4288913aedc26;0;2;9;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2043;-2432,544;Inherit;False;ExperimentalScreenSpaceShadows;33;;721;79f826106fc5f154c96059cc1326b755;0;1;85;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;640;1232.082,-544.3308;Inherit;False;SimplePosterize;-1;;722;163fbd1f7d6893e4ead4288913aedc26;0;2;9;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;549;-3248,-448;Inherit;False;Property;_ShadingSoftness;Shading Softness;5;0;Create;True;0;0;0;False;0;False;0.5;0.5;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;721;-1264,784;Inherit;False;Property;_ParticleMesh;ParticleMesh;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;255;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;471;-2688,-432;Inherit;False;Property;_ShadingBlend;Shading Blend;4;0;Create;True;0;0;0;False;1;Space(5);False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;649;464,-128;Inherit;False;Property;_HaloTint;Halo Tint;8;1;[HDR];Create;True;1;___Halo___;0;0;False;0;False;1,1,1,1;2.484021,0.7022887,0,0.427451;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.VertexColorNode;650;672,-80;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;481;192,-224;Inherit;True;Property;_GradientTexture;GradientTexture;0;2;[Header];[SingleLineTexture];Create;True;1;___Light Settings___;0;0;False;1;Space(10);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StepOpNode;485;190.3592,-975.1706;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.999;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;607;224,304;Inherit;True;Property;_ColorGradient;ColorGradient;0;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;481;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.VertexColorNode;201;704,432;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;140;512,352;Inherit;False;Property;_LightTint;Light Tint;1;1;[HDR];Create;True;1;___Light Settings___;0;0;False;0;False;1,1,1,1;2.118547,0.4788287,0,0.5254902;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;1952;1248,688;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexCoordVertexDataNode;1916;1216,848;Inherit;False;0;3;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;1917;1440,688;Inherit;False;Property;_ParticleMesh;ParticleMesh;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;255;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.StaticSwitch;1971;1424,-288;Inherit;False;Property;___Halo___;___Halo___;6;0;Create;True;0;0;0;False;1;Space(25);False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;1384;1792,544;Inherit;False;416;FlickerAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1977;1824,480;Inherit;False;DayAlpha;31;;723;bc1f8ebe2e26696419e0099f8a3e27dc;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1988;1664,624;Inherit;False;AdvancedCameraFade;11;;724;e6e830f789d28b746963801d61c2a1ec;0;6;40;FLOAT;0;False;46;FLOAT;0;False;47;FLOAT;0;False;48;FLOAT;0;False;17;FLOAT3;0,0,0;False;20;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1897;1888,272;Inherit;False;1892;FlickerHue;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;600;1664,208;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1901;1984,528;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;2014;-928,256;Inherit;False;Property;_ObjectScale;ObjectScale;7;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMinOpNode;2009;-1296,224;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;657;2080,208;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2017;2240,208;Float;False;True;-1;2;;100;5;LazyEti/BIRP/FakePointLight;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;4;1;False;;1;False;;2;5;False;;10;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;1;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;7;False;;True;True;1000;False;;2000;False;;True;2;RenderType=Overlay=RenderType;Queue=Overlay=Queue=0;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;7;Include;;False;;Native;False;0;0;;Custom;#ifdef STEREO_INSTANCING_ON;False;;Custom;False;0;0;;Custom;UNITY_DECLARE_TEX2DARRAY_NOSAMPLER(_CameraDepthNormalsTexture)@;False;;Custom;False;0;0;;Custom;#else;False;;Custom;False;0;0;;Custom;UNITY_DECLARE_TEX2D_NOSAMPLER(_CameraDepthNormalsTexture)@;False;;Custom;False;0;0;;Custom;#endif;False;;Custom;False;0;0;;Custom;SamplerState sampler_CameraDepthNormalsTexture@;False;;Custom;False;0;0;;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;True;0
WireConnection;539;0;2040;0
...
ASEEND*/
//CHKSM=0E06689CE3127A7BB6700164AEDB30DE97EA0068