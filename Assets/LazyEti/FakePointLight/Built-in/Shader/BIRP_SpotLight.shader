	...
	LOD 100
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float3 vertexToFrag7_g56 = worldSpaceLightDir;
				o.ase_texcoord4.xyz = vertexToFrag7_g56;
			...
			fixed4 frag (v2f i , bool ase_vface : SV_IsFrontFace) : SV_Target
			{
				...
				float3 vertexToFrag7_g56 = i.ase_texcoord4.xyz;
				float dotResult3_g56 = dot( -vertexToFrag7_g56 , float3( 0,1,0 ) );
				float4 lerpResult130 = lerp( ( _LightColor * _LightColor.a * ( smoothstepResult124 * saturate( lerpResult16_g54 ) * ifLocalVar145 ) * (( DistanceFade )?( ( saturate( ( 1.0 - ( ( Dist41_g57 - _FarFade ) / _FarTransition ) ) ) * saturate( ( ( Dist41_g57 - _CloseFade ) / _CloseTransition ) ) ) ):( 1.0 )) * float4( ( staticSwitch53_g55 * lerpResult51_g55 ) , 0.0 ) ) , _OffColor , ( _TurnOff * (( DayAlpha )?( saturate( ( dotResult3_g56 * 4.0 ) ) ):( 1.0 )) ));
...
Node;AmplifyShaderEditor.FunctionNode;157;-1623.815,-613.4585;Inherit;False;DepthFade Ortho Friendly;-1;;54;c999fe3990bf5904e85a29ae76d248e8;0;1;22;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;117;-912,-768;Inherit;False;505.8481;313.4387;;2;129;127;Light Color;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;118;-368,-672;Inherit;False;639;495;;5;142;140;139;138;130;Off Color;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;132;-768,-160;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;140;-208,-272;Inherit;False;DayAlpha;18;;56;bc1f8ebe2e26696419e0099f8a3e27dc;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;127;-560,-624;Inherit;False;5;5;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;116;320,-624;Float;False;True;-1;2;;100;5;LazyEti/BIRP/SpotLight;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;4;1;False;;1;False;;5;4;False;;1;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=C3A3C484F513ECCB28831D9764D079E7E4B8B791